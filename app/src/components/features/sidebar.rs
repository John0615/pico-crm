        ...
        <div class="drawer-side">
            ...
            <div class="p-4 w-64 h-full bg-base-200">
                ...
                <div class="flex items-center p-4 rounded-lg bg-gradient-to-r from-primary/10 to-secondary/10 border border-base-300 mb-4">
                    ...
                    <div class="ml-3">
                        <p class="font-bold text-sm">"管理员"</p>
                        <p class="text-xs opacity-70">"admin@picocrm.com"</p>
                    </div>
                </div>

                // 主菜单
                <ul class="menu menu-sm bg-base-200 rounded-box w-full space-y-2">
                    // 智能看板
                    <li>
                        <a
                            href="/"
                    ...
                    <li>
                        <a
                            href="/contacts"
                            class=move || if is_active("/contacts") { "menu-active" } else { "" }
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                    ...
                    // 管理中心 - 恢复折叠菜单
                    <li>
                        <details prop:open=move || is_admin_section()>
                            <summary class=move || if is_admin_section() { "menu-active" } else { "" }>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                            ...
                            <ul class="space-y-1 mt-1">
                                <li>
                                    <a
                                        href="/admin/users"
                                        class=move || if is_active("/admin/users") { "menu-active" } else { "" }
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                                ...
                                <li>
                                    <a
                                        href="/admin/settings"
                                        class=move || if is_active("/admin/settings") || is_active("/admin") { "menu-active" } else { "" }
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-base-300">
                    <div class="flex justify-between items-center">
                        <div class="tooltip tooltip-top" data-tip="系统设置">
                        ...
                        <div class="tooltip tooltip-top" data-tip="主题切换">
                            <button class="btn btn-ghost btn-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                        ...
                        <div class="tooltip tooltip-top" data-tip="退出登录">
