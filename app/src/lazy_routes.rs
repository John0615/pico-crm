...
use crate::pages::admin::{AdminAnalytics, AdminMerchants, AdminUsers, SystemSettings};
use crate::pages::{
    AdminLogin, ContactsManagement, Dashboard, Login, OrdersPage, SchedulesPage,
    ServiceCatalogsPage, ServiceRequestsPage,
};
...
#[derive(Debug)]
pub struct AdminLoginRoute;

#[lazy_route]
impl LazyRoute for AdminLoginRoute {
    fn data() -> Self {
        Self
    }
    ...
    fn view(this: Self) -> AnyView {
        let _ = this;
        view! { <AdminLogin/> }.into_any()
    }
}

#[derive(Debug)]
pub struct ContactsManagementRoute;

#[lazy_route]
impl LazyRoute for ContactsManagementRoute {
    fn data() -> Self {
        Self
    }
    ...
    fn view(this: Self) -> AnyView {
        let _ = this;
        view! { <ContactsManagement/> }.into_any()
    }
}
...
#[derive(Debug)]
pub struct ServiceCatalogsRoute;

#[lazy_route]
impl LazyRoute for ServiceCatalogsRoute {
    fn data() -> Self {
        Self
    }
    ...
    fn view(this: Self) -> AnyView {
        let _ = this;
        view! { <ServiceCatalogsPage/> }.into_any()
    }
}
