...
use lazy_routes::{
    AdminAnalyticsRoute, AdminMerchantsRoute, ContactsManagementRoute, DashboardRoute, LoginRoute,
    OrdersRoute, SchedulesRoute, ServiceCatalogsRoute, ServiceRequestsRoute, SystemSettingsRoute,
    UsersRoute,
};
