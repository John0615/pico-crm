...
use crate::domain::crm::order::OrderStatus;
...
mod tests {
    ...
    fn schedule_status_transition_rules() {
        assert!(
            ScheduleStatus::validate_transition(ScheduleStatus::Planned, ScheduleStatus::InService)
                .is_ok()
        );
        assert!(
            ScheduleStatus::validate_transition(ScheduleStatus::Planned, ScheduleStatus::Cancelled)
                .is_ok()
        );
        assert!(
            ScheduleStatus::validate_transition(ScheduleStatus::InService, ScheduleStatus::Done)
                .is_ok()
        );
        assert!(
            ScheduleStatus::validate_transition(
                ScheduleStatus::InService,
                ScheduleStatus::Cancelled
            )
            .is_ok()
        ...
        assert!(
            ScheduleStatus::validate_transition(ScheduleStatus::Done, ScheduleStatus::Cancelled)
                .is_err()
        );
    }
