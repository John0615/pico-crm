...
use crate::domain::crm::service_request::ServiceRequest as DomainServiceRequest;
...
impl From<DomainServiceRequest> for SharedServiceRequest {
    fn from(request: DomainServiceRequest) -> Self {
        Self {
            ...
            appointment_start_at: request.appointment_start_at.map(parse_utc_time_to_string),
            appointment_end_at: request.appointment_end_at.map(parse_utc_time_to_string),
